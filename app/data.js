...
const uiText = {
  de: {
    ...
    storyboard: {
      ...
      tableHeaders: ["№", "Lektion", "Start", "Ende"],
      cardLabels: {
  ...
  ru: {
    ...
    storyboard: {
      ...
      tableHeaders: ["№", "Урок", "Начало", "Конец"],
      cardLabels: {
  ...
  uk: {
    ...
    storyboard: {
      ...
      tableHeaders: ["№", "Урок", "Початок", "Кінець"],
      cardLabels: {
