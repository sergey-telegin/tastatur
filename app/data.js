...
const uiText = {
  de: {
    ...
    showAllFingers: "Alle Finger zeigen",
    hideAllFingers: "Farben ausblenden",
  ...
  en: {
    ...
    showAllFingers: "Show All Fingers",
    hideAllFingers: "Hide Colors",
  ...
  ru: {
    ...
    showAllFingers: "Показать все пальцы",
    hideAllFingers: "Скрыть цвета",
