...
let practiceAlternateLineRepeat = false;
let onboardingStepIndex = 0;
let onboardingCompleted = false;
let activeOnboardingFlow = null;
let shownOnboardingEventIds = new Set();
...
function initializeAppState(savedState = {}) {
  ...
  shownOnboardingEventIds = new Set(Array.isArray(savedState.shownOnboardingEventIds) ? savedState.shownOnboardingEventIds : []);
